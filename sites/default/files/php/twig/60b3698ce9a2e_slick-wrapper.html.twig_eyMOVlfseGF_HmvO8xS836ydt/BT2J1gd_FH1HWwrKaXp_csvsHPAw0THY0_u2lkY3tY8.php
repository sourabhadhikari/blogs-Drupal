...
class __TwigTemplate_573c6603a7d18f37d68ef9e3ca457ffcabe256eb4b5ec6527489804b30a1309b extends \Twig\Template
{
...
($context["settings"] ?? null), "thumbnail_position", []))) ? (("slick-wrapper--tn-" . twig_replace_filter($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["settings"] ?? null), "thumbnail_position", [])), ["over-" => ""]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "modules/contrib/slick/templates/slick-wrapper.html.twig", "E:\\blogs\\modules\\contrib\\slick\\templates\\slick-wrapper.html.twig");
    }
}
